...
class NewsAnalyzerApp:
    ...
    # ... (fungsi get_column_mapping tidak berubah) ...
  ...
  # ... (fungsi get_column_mapping tidak berubah) ...
    ...
    def process_urls_manual(self, urls: List[str], config: Dict) -> List[Dict]:
        ...
        for i, url in enumerate(urls):
            ...
            try:
                ...
                # --- MODIFIKASI: Menambahkan pemanggilan fitur baru ---
    ...
    def process_excel_data(self, df: pd.DataFrame, column_mapping: Dict, config: Dict) -> pd.DataFrame:
        ...
        for i, row in df.iterrows():
            ...
            # ... (bagian scraping dan penentuan analysis_text tidak berubah) ...
    ...
    def display_results(self, results, config: Dict, is_excel_data: bool = False):
        # ... (Bagian atas display_results tidak berubah signifikan) ...
        ...
        # --- MODIFIKASI: Menambahkan fitur baru ke ringkasan ---
        st.info(f"📊 **Metode Scraping:** ...") # Bagian ini tidak berubah
        ...
        # ... (Sisa fungsi display_results tidak perlu diubah, karena kolom baru akan otomatis ditampilkan) ...
        if success_count > 0:
            st.subheader("📤 Export Data")
            # ... (logika export tidak perlu diubah) ...
        st.subheader("📋 Preview Hasil")
        # ... (logika preview tidak perlu diubah) ...
    def validate_configuration(self, config: Dict, urls: List[str], uploaded_file=None) -> List[str]:
        warnings = []
        
        # --- MODIFIKASI: Menambahkan validasi untuk fitur baru ---
        if not any([
        ...
        # --- BARU: Validasi untuk konfigurasi topik ---
        if config['enable_topic']:
    ...
    # ... (fungsi run tidak berubah, karena semua logika sudah diatur di fungsi-fungsi yang dipanggilnya) ...
    def run(self):
      self.setup_page()
